package ivannotar.regazbot.web;
...
@Controller
public final class RegazBotController {
	
	private static String project;
	private static final Logger logger = LoggerFactory.getLogger(RegazBotController.class);
